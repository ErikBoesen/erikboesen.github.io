...
% Chop content past first page - disable this to fix some compilation errors
\let\clearpage\relax
...
\vspace{-7mm}
\section*{Skills}
Python, Java/Kotlin, JavaScript (TypeScript, React, Angular), HTML/CSS, Ruby, UNIX, PHP, Agile, JIRA, ML, AI, LLMs, Technical Writing, Swift, C/C++, Go, Perl, Lisps, Datadog, SumoLogic, Kubernetes\\
