...
\begin{itemize}
    ...
    \item Wrote technical design documentation for front- and back-end of new feature implementation and integrated teammate feedback
...
\begin{itemize}
    ...
    \item Built expanded directory app for public at \href{https://yalies.io}{yalies.io}; now used by 5,000+ students, with API backing campus websites with 24,000+ total users
\end{itemize}
...
\begin{itemize}
    ...
    \item Auutomated Node dependency security audits with Snyk and Yarn, updating 800+ vulnerable dependencies across 12 microservices
\end{itemize}
