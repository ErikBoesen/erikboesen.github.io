...
\section*{Education}
\noindent
\textbf{Yale University}, 2019-2024, BS, Computer Science. (On leave \& employed full-time 2020-21.) New Haven, CT\\
...
\textbf{Yale University} / \textit{Undergraduate Learning Assistant}\hfill \textsc{Aug 2020 --}\\
\begin{itemize}
    \vspace{-6mm}
    \item On teaching staff of CPSC 201, Introduction to Computer Science. Conducted office hours, instructing students in Racket (LISP) programming.
    \item Graded exams and weekly problem sets, including maintaining suite of Python/Bash scripts used for autograding and course communication
\end{itemize}
